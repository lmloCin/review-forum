...
function EditMoviePage() {
  ...
  const [tagsInput, setTagsInput] = useState(''); // Estado separado para o input de tags
  ...
  useEffect(() => {
    ...
    const fetchMovie = async () => {
      try {
        ...
        // Inicializa o estado do input de tags com os dados da API
  ...
  return (
    <div className={styles.page}>
      ...
      <form onSubmit={handleSubmit} className={styles.form}>
        ...
        <div className={styles.formGroup}>
          <label htmlFor="posterUrl" className={styles.label}>Poster (URL)</label>
          <input type="text" id="posterUrl" name="posterUrl" value={movie.posterUrl || ''} onChange={handleChange} className={styles.input} />
        </div>
        <div className={styles.buttonGroup}>
          <button type="button" onClick={() => navigate(`/movie/${id}`)} className={`${styles.button} ${styles.cancelButton}`}>
            Cancelar
          </button>
