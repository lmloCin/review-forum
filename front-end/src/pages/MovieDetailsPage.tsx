    ...
    <div className={styles.pageContainer}>
      <div className={styles.mainContent}>
        <section className={styles.posterSection}>
          <img src={movie.posterUrl || `https://placehold.co/280x420/14181C/ffffff?text=${movie.name}`} alt={`Poster de ${movie.name}`} className={styles.poster} />
        </section>
        <section className={styles.detailsSection}>
          ...
          {/* CORREÇÃO: Posição da nota alterada */}
          ...
          <div className={styles.actions}>
            {isAdmin ? (
              <div className={styles.adminControls}>
                <Link to={`/movie/${movie.id}/edit`} className={styles.adminButton}>
                  Edit Movie
                </Link>
      ...
      <section className={styles.reviewsSection}>
        {/* CORREÇÃO: Título e botão de adicionar review agora estão juntos */}
        <div className={styles.reviewsHeader}>
            <h2 className={styles.reviewsTitle}>Reviews</h2>
            {isAdmin && (
                 <Link to={`/movie/${movie.id}/add-review`} className={styles.addReviewButton}>
                  + Add Review
                </Link>
            )}
        </div>
